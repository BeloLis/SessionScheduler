...
// SessionSchedulerGUI.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSessionSchedulerGUIApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSessionSchedulerGUIApp

CSessionSchedulerGUIApp::CSessionSchedulerGUIApp()
{
...
// Единственный объект CSessionSchedulerGUIApp

CSessionSchedulerGUIApp theApp;


// Инициализация CSessionSchedulerGUIApp

BOOL CSessionSchedulerGUIApp::InitInstance()
{
